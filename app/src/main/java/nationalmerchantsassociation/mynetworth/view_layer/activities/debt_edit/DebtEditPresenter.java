...
public class DebtEditPresenter implements DebtEditContract.Presenter {

    private String debtNamePrevious;
    private String debtName;
    private String debtCategory;
    private DebtEditContract.View view;
    private DataManager dataManager;

    public DebtEditPresenter(DebtEditContract.View debtUpdateView, DataManager dataManager) {
