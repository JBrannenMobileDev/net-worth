...
public class AssetEditPresenter implements AssetsEditContract.Presenter {

    private String assetNamePrevious;
    private String assetName;
    private String assetCategory;
    private AssetsEditContract.View view;
    private DataManager dataManager;

    public AssetEditPresenter(AssetsEditContract.View assetUpdateView, DataManager dataManager) {
