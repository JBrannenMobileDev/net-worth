...
public class CreateDebtPresenter implements CreateDebtContract.Presenter {
    private CreateDebtContract.View view;
    private DataManager dataManager;
    private String category;
    private String month;
    private int year;

    public CreateDebtPresenter(CreateDebtContract.View createDebtView, DataManager dataManager) {
