...
public class DebtUpdatePresenter implements DebtUpdateContract.Presenter {

    private String debtName;
    private DebtUpdateContract.View view;
    private Realm realm;
    private DataManager dataManager;
    private String month;
    private int year;

    public DebtUpdatePresenter(DebtUpdateContract.View debtUpdateView, Realm mainUiRealm, DataManager dataManager) {
