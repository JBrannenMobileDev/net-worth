...
public class CreateAssetPresenter implements CreateAssetContract.Presenter {
    private CreateAssetContract.View view;
    private DataManager dataManager;
    private String category;
    private String month;
    private int year;

    public CreateAssetPresenter(CreateAssetContract.View createAssetView, DataManager dataManager) {
