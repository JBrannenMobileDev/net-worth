...
public class DebtDetailsPresenter implements DebtDetailsContract.Presenter {
    private static final String EMPTY_STRING = "";
    private DebtDetailsContract.View view;
    private Realm realm;
    ...
    public DebtDetailsPresenter(DebtDetailsContract.View debtView, Realm mainUiRealm) {
        this.view = debtView;
