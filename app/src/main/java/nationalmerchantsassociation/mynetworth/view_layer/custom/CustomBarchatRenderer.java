...
import nationalmerchantsassociation.mynetworth.utils.GerneralUtils;

/**
 * Created by jbrannen on 11/8/17.
 */

public class CustomBarchatRenderer extends BarChartRenderer {
    private float radius;
    public CustomBarchatRenderer(BarDataProvider chart, ChartAnimator animator, ViewPortHandler viewPortHandler, Context mContext) {
        super(chart, animator, viewPortHandler);
        radius = GerneralUtils.pxFromDp(mContext, 4);
    }
